    ...
    render(){
        return(
            <div className="relative overflow-hidden">
                <video autoPlay muted loop className="w-screen h-screen object-cover md:block hidden">
                    <source src={BlockChainBg2} type="video/mp4" />
                </video>
                <img src={header_bg} alt="header_bg" className="w-screen h-screen object-cover md:hidden" />
