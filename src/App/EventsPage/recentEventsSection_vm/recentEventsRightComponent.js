...
import events_img_2 from "../../../assets/Vm/Vm7.jpg";
  ...
  render() {
    var events_arr = [
      {
        ...
        event_name: "The Virtual Matrix",
        event_location: "Pune, India",
        event_date: "31st March 2023",
        event_about:
          "Under the banner of BHARTIYAM'23, Blotic organized “The Virtual Matrix,” which allowed AR-VR enthusiasts to witness Virtual Reality in the most creative way possible. People from all over Pune joined in to experience various games and visualizations through the Virtual Reality setup.",
        nav_to: "https://www.instagram.com/p/Cq2etD1Aqq-/",
      },
    ...
    var events_card = events_arr.map((event, index) => {
      return (
        <div
          key={index}
          id={`event_slider_${index}`}
          className="bg-white rounded-b-2xl flex-shrink-0 h-full w-full space-y-5 transform transition-all duration-500"
        >
          <img
            src={event.events_img}
          ...
          <div className="p-5 space-y-5 flex flex-col  justify-between">
            <div className="flex">
              ...
              <p className="text-md my-auto font-light text-gray-500">
                {event.event_date}
              </p>
            </div>
            ...
            <div className="flex justify-between">
              <button className="text-center p-3 px-5 max-w-max bg-black text-white">
                <a href={event.nav_to}>Know More</a>
              </button>
              <button
                onClick={() => {
                  ...
                  if (index === events_arr.length - 1) {
                    ...
                    for (var i = 0; i < events_arr.length; i++) {
                      ...
                      document.getElementById(
                        `event_slider_${j}`
                      ).style.transform = `translateX(${j}00vw)`;
                    }
                  } else {
                    document.getElementById(
                      `event_slider_${index}`
              ...
              >
                <img
                  src={right_arrow}
                  alt="right_arrow"
                  className="w-12 h-12 p-2 rounded-full bg-gray-200"
                />
              </button>
            </div>
          </div>
    ...
    return <div className="md:w-2/5 flex overflow-hidden">{events_card}</div>;
  }
}
